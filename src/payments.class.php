<?php
    ...
    class Payments
    {
        ...
        public function getPaymentsList($type, $paymentStatus = 'paid', $lastPaymentId = 0, $page = 1, $itemsPerPage = 10, $sortOrder = 'DESC') {
            ...
            if ($conn = $this->openConnection()) {
                ...
                try {
                    ...
                    if ($lastPaymentId != 0) {
                        $query->bindValue(':after_payment_id', $lastPaymentId);
                    }            
