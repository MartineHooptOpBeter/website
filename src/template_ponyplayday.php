<?php /* Template Name: Pony Play Day Page */ ?>
<?php

    @@HEADER@@

	include_once 'ponyplayday.php'; 
...
<?php 
	...
	if ($ponyPlayDayPage->doShowPonyPlayDayForm) {
		...
		$ponyPlayDayPage->showPonyPlayDayForm();
	}

	if ($ponyPlayDayPage->doShowPonyPlayDayConfirmation) {

		$ponyPlayDayPage->showPonyPlayDayConfirmation();
